...
output_data_path=$output_data_path/melbands/$name_db
...
echo ============================================================================
echo "            MelBands Feature Extraction for single audio file             "
echo ============================================================================


#    echo "Usage: $0 [options] <data-dir> [<log-dir> [<fbank-dir>] ]";
steps/make_fbank_pablo.sh --cmd "$train_cmd" --nj $njobs $input_data_path $input_data_path/log $output_data_path

# export features as ASCII
fbank_file_out=$output_data_path/raw_fbank_voctro.1.ark
