...
output_data_path=$output_data_path/mfcc-world/$name_db
...
python make_mfcc_world_librosa.py $input_data_path $output_data_path "voctro" $njobs 1
# # export features as ASCII<s

# export features as ASCII
fbank_file_out=$output_data_path/raw_mfcc_voctro.1.txt
#../../../src/featbin/copy-feats ark:"$fbank_file_out" ark,t:"${fbank_file_out%.ark}.ascii";

# Saving as Numpy Data
python plot_data_voctro.py $fbank_file_out $output_data_path
