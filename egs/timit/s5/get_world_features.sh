...
python make_mfcc_world.py $input_data_path $data_mfcc "voctro" $njobs
# export features as ASCII
 mfcc_file_out=$data_mfcc/raw_mfcc_voctro.1.txt
...
mv ${mfcc_file_out%.txt}.scp $data_mfcc/feats.scp
mv  $data_mfcc/feats.scp $input_data_path
